...
console.log("== UI source: cell menus ==");
{
  ...
  assert(/@container ops-assign \(min-width: 880px\)/.test(page), "PC side-by-side from content width 880");
  ...
  assert(/max-width: 879px/.test(page), "no forced side panel on narrow content");
