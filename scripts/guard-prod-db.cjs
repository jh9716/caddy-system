...
function isReadonlyInspectArgv() {
  ...
  return /inspect-db-schema-readonly|check-migration-checksums-readonly|export-caddies-snapshot|preview-roster-import|inspect-special-assign-prod-readonly|inspect-reflow-prod-readonly|inspect-sick-spare-prod-readonly|inspect-unavail-ops-prod-readonly/.test(
    s
  );
}
